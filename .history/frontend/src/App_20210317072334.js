...
import './App.css';
import { RegisterComponent, LoginComponent, PlaceComponent, PlacesComponent, TagComponent, TagsComponent, CreatePlaceComponent } from './components/index';
        ...
        <div>
            <BrowserRouter>
                <Switch>
                    ...
                    <Route exact path="/create/places" render={() => <CreatePlaceComponent />}/>
