                    ...
                    <div style={{flex: 5, flexWrap: 'wrap'}}>
                        ...
                        <div>
                            <Carousel 
                                ...
                                slide
                                prevIcon={(
                                    <p className="carousel-contol-prev-icon" style={{marginLeft: -16}}>&#60;</p>
                                )}
                                nextIcon={(
                                    <p className="carousel-contol-next-icon" style={{marginRight: -16}}>&#62;</p>
                                )}
                            >
                                <Carousel.Item
                                ...
                                >
                                    ...
                                    <p className="mt-4 text-muted" style={{flexGrow: 1, textAlign: 'justify'}}>adsfsadklfj f</p>
                                ...
                                >
                                    ...
                                    <p className="mt-4 text-muted" style={{flexGrow: 1, textAlign: 'justify'}}>hi</p>
                                    <h6>thisistheuser &#183; Mar 17</h6>
                                </Carousel.Item>
                            </Carousel>
                        </div>
