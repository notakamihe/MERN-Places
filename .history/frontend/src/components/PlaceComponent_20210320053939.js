...
export default function PlaceComponent(props) {
    ...
    useEffect(() => {
        ...
        geocoder.geocode( {'address': 'New York', key: 'AIzaSyCVKN0OkpgwrZcdZ0V4GF3zqBB7wFkhVOw'}, function(results, status) {
        ...
        <div style={{margin: "auto 160px"}}>
            {
                ...
                <div className="d-flex" style={{margin: '64px auto'}}>
                    <div style={{flex: 4, flexWrap: 'wrap'}}>
                        ...
                        <LoadScript
                            googleMapsApiKey="AIzaSyCVKN0OkpgwrZcdZ0V4GF3zqBB7wFkhVOw"
                        >
                            <GoogleMap
