    ...
    return (
        <div className="mt-5">
            ...
            <div className="mx-auto py-4 rounded" style={{backgroundColor: "#0002", width: "25%"}}>
                ...
                <div className="d-flex mb-2 col-12" style={{flexWrap: 'wrap'}}>
                    <p 
                        style={{
                            flex: 0.4, 
                            fontSize: 16, 
                    ...
                    <p 
                        style={{flex: 0.6, fontSize: 16, textAlign: 'center', wordWrap: 'break-all'}} 
                        className="m-0 text-muted">
                        {user.email}dsggsdfgfdsgsgfdsgdsgsfgsf
                    </p> 
                </div>
                <div className="d-flex mb-2 col-12">
                    <p 
                    ...
                    <p 
                        style={{flex: 0.6, fontSize: 16, textAlign: 'center', wordWrap: 'break-word'}} 
                        className="m-0 text-muted">
                        {user.address}
                    </p> 
                </div>
