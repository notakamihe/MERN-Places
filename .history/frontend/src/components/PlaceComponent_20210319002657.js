                    ...
                    <div style={{flex: 5, flexWrap: 'wrap'}}>
                        ...
                        <div>
                            <div className="d-flex mb-2" style={{width: 200}}>
                                <p style={{flex: 0.3, fontSize: 14, fontWeight: 'bold'}} className="m-0 text-muted">
                                    Day
                                </p> 
                                <p style={{flex: 0.35, fontSize: 14}} className="m-0 text-muted">
                                    Start
                                </p> 
                                <p style={{flex: 0.35, fontSize: 14}} className="m-0 text-muted">
                                    End
                                ...
                                Object.keys(place.hoursOpen || {}).map(d => (
                                    <div>
                                        <div className="d-flex" style={{width: 200}}>
                                            <p style={{flex: 0.3, fontSize: 14, fontWeight: 'bold', textAlign: 'right'}} className="m-0 text-muted">
