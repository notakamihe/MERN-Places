...
export default function PlacesComponent() {
    ...
    return (
        <div className="my-5">
            <h1 style={{textAlign: 'center', fontSize: 48, letterSpacing: 8, fontFamily: 'sans-serif', fontWeight: 'bold'}} className="my-5">PLACES</h1>
            ...
            <div style={{justifyContent: 'center'}} className="mx-auto d-flex my-5">
                ...
                <form className="mx-5" style={{textAlign: 'center'}}>
                    <TextField 
                        variant="outlined" 
                        type="search" 
                        className="" 
