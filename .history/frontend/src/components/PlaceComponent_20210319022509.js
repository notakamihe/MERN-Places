                    ...
                    <div style={{flex: 5, flexWrap: 'wrap'}}>
                        ...
                        <div>
                            ...
                            >
                                <Carousel.Item
                                    className="rounded"
                                    style={{border: "1px solid #f50057", minHeight: 300, textAlign: 'center'}}
                                >
                                    <div className="mt-4">
                                        <StarRatings
                                            rating={place.averageRating}
                                    ...
                                    <p className="mt-4 text-muted font-weight-bold">adsfsadklfj jfkjdsafkjk jdsafk jasdklfj klasdjfkj askdfj kaljfkasj dkfadsj kfjasdkfj kalsdjf klajds kljadfskl jfadsklfj klasjdfk jasdkfja skldfjaklsdjf klasdjfklj asdklfj kasljfkl jadklsj fjfklasdfj</p>
                                </Carousel.Item>
                                <Carousel.Item
                                    className="rounded"
