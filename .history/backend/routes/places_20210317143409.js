...
router.post('/', upload.single('image'), async (req, res) => {
    ...
    const payload = {name, description, ratings, location, hoursOpen, tags, additionalInfo, imageUrl}
...
router.put('/:id', upload.single(), async (req, res) => {
    ...
    const payload = {name, description, ratings, location, hoursOpen, tags, additionalInfo, imageUrl : req.file.path}
