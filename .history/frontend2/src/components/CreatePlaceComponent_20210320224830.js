        ...
        <div className="pt-5 px-5 mx-auto" style={{paddingBottom: 128}}>
            ...
            <form className="mx-auto col-10 mt-5">
                ...
                <div className="col-10 mx-auto text-center mt-5">
                    <DayRow day="Sunday" startCallback={setSunStartTime} endCallback={setSunEndTime} />
                    <DayRow day="Monday" startCallback={setMonStartTime} endCallback={setMonEndTime}/>
                    <DayRow day="Tuesday" startCallback={setTueStartTime} endCallback={setTueEndTime}/>
                    <DayRow day="Wednesday" startCallback={setWedStartTime} endCallback={setWedEndTime}/>
                    <DayRow day="Thursday" startCallback={setThuStartTime} endCallback={setThuEndTime}/>
                    <DayRow day="Friday" startCallback={setFriStartTime} endCallback={setFriEndTime}/>
                    <DayRow day="Saturday" startCallback={setSatStartTime} endCallback={setSatEndTime}/>
                </div>
