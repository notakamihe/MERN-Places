...
export default function PlaceComponent(props) {
    ...
    const removeRating = (id) => {
        ...
        newPlace.ratings = newPlace.ratings.filter(r => r.user._id != id)
        console.log(newPlace.ratings);
    }
                    ...
                    <div style={{flex: 4, flexWrap: 'wrap'}}>
                        ...
                        <h4 id="place-address" onClick={() => setShowMapModal(true)}>{place.location}</h4>
                        {
                            ...
                            <div className="d-flex">
                                ...
                                <p>{numeral(place.averageRating).format("0.00")} stars</p>
                            </div> : null
                        }
                                            ...
                                            place.ratings.map((r, index) => (
                                                ...
                                                >
                                                    ...
                                                    <h6>{r.user.name} &#183; {moment(new Date(Date.parse(r.addedOn))).format('ll')}</h6>
                                                    {
                                                        r.user._id == user._id ? 
                                                        <Button 
                                                            onClick={() => removeRating(r.user._id)}
                                                        >
                                                            Delete
                                                        </Button> : null
                                                    }
                        ...
                        <div className="text-center">
                            {
                                user && place.ratings && !place.ratings.map(r => r.user._id).includes(user._id) ? 
                                <Button
                                    color="secondary"
                                    variant="outlined"
                                    startIcon={<FaPlus />}
