...
export default function CreatePlaceComponent() {
    ...
    const createPlace = (e) => {
        ...
        console.log(sunStartTime, sunEndTime);
        console.log(monStartTime, monEndTime);
        console.log(tueStartTime, tueEndTime);
        console.log(wedStartTime, wedEndTime);
        console.log(thuStartTime, thuEndTime);
        console.log(friStartTime, friEndTime);
        console.log(satStartTime, satEndTime);
    }
    ...
    return (
        <div className="pt-5 px-5 mx-auto" style={{paddingBottom: 128}}>
            ...
            <form className="mx-auto col-10 mt-5" onSubmit={createPlace}>
                ...
                {error ? <p className="alert alert-danger col-10 mt-4 mx-auto">{error}</p> : null}
            </form>
        </div>
    )
}
