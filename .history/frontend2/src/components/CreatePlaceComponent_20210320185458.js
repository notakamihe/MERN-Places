        ...
        <div className="py-5 mx-auto">
            ...
            <form className="mx-auto col-10 mt-5">
                ...
                <div className="col-10 mx-auto text-center mt-5">
                    <div className="d-flex align-items-center text-center mx-auto" style={{justifyContent: "center"}}>
                    ...
                    <div className="d-flex align-items-center">
                        <h5 className="m-0 p-3 mx-5 rounded" style={{backgroundColor: "#0003"}}>Monday</h5>
                        <div>
                            <TextField 
                                type="time"
                                label="Opens"
                    ...
                    <div className="d-flex align-items-center">
                        <h5 className="m-0 p-3 mx-5 rounded" style={{backgroundColor: "#0003"}}>Tuesday</h5>
                        <div>
                            <TextField 
                                type="time"
                                label="Opens"
                    ...
                    <div className="d-flex align-items-center">
                        <h5 className="m-0 p-3 mx-5 rounded" style={{backgroundColor: "#0003"}}>Wednesday</h5>
                        <div>
                            <TextField 
                                type="time"
                                label="Opens"
