...
import { RegisterComponent, LoginComponent, PlaceComponent, PlacesComponent, TagComponent, TagsComponent, CreatePlaceComponent, ProfileComponent, CreateTagComponent} from './components/index';
        ...
        <div>
            <BrowserRouter>
                <Switch>
                    ...
                    <Route exact path="/create/place" render={() => <CreateTagComponent />}/>
